package com.gogofnd.theCreditableCMS.domain.terminal.api;
...
import com.gogofnd.theCreditableCMS.domain.terminal.service.TerminalService;
...
public class TerminalApi {
    ...
    public ResponseEntity<Boolean> checkTidDuplicate(@PathVariable int tid) {
